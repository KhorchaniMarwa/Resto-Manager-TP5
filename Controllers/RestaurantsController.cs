...
namespace RestoManager_Marwa.Controllers
{
    public class RestaurantsController : Controller
    {
        ...
        {
            ViewData["NumProp"] = new SelectList(_context.Proprietaires, "Gsm", "Gsm");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("CodeResto,NomResto,Specialite,Ville,Tel,NumProp")] Restaurant restaurant)
        {
            ...
            ViewData["NumProp"] = new SelectList(_context.Proprietaires, "Gsm", "Gsm", restaurant.NumProp);
            return View(restaurant);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CodeResto,NomResto,Specialite,Ville,Tel,NumProp")] Restaurant restaurant)
        {
