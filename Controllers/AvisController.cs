...
namespace RestoManager_Marwa.Controllers
{
    public class AvisController : Controller
    {
        ...
        {
            ViewData["NumResto"] = new SelectList(_context.Restaurants, "CodeResto", "CodeResto");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("CodeAvis,NomPersonne,Note,Commentaire,NumResto")] Avis avis)
        {
            ...
            ViewData["NumResto"] = new SelectList(_context.Restaurants, "CodeResto", "CodeResto", avis.NumResto);
            return View(avis);
        }
